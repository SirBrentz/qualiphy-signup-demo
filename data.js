...

  {
    ...
    answers: [
      ...
      { id: 'emr', label: 'From our EMR or practice software',
        desc: 'Zenoti, Jane, Aesthetic Record and more. Patients and results stay in your system.',
    ...
    followups: [
      { id: 'emr', type: 'emrpicker', showIf: ['emr'],
        label: 'Choose your EMR integration',
        note: '',
        effects: [{ label: 'EMR selection', where: 'signup', inv: 'EMR selection', via: '/clinic_sign_up (emr, custom_emr)' },
                  { label: 'Unsupported EMR demand (every selection)', where: 'nowhere', inv: null, via: 'signup stores one EMR today' }] },
